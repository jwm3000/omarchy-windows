...
- [ ] Reconfirm marketplace requirements for automatic first-start setup: enabling the plugin can launch an installer that adds Lua integration and requests sudo in a visible terminal.
